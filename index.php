...
$skills = [
    ...
    "Service" => [
        ...
        "Arduino" => "http://content.arduino.cc/brand/arduino-white.svg",
        ...
        "OneDrive" => "img/onedrive.svg",
        "Office" => "img/office.svg",
        "Canva" => "img/canva.svg",
        "Adobe" => "https://www.adobe.com/content/dam/cc/icons/Adobe_Corporate_Web_Logo.svg",
        "Google Apps Script" => "img/google_script_apps.svg",
        "Google Colab Colaboratory" => "img/google_colaboratory.png",
        "Google Admins" => "img/google_admin.svg",
        "Google Groups" => "img/google_groups.png",
        "Google Workspace" => "https://workspace.google.com/static/img/google-workspace-logo.svg",
        "Glitch" => "img/glitch.svg",
        "Square Up" => "img/square.svg",
